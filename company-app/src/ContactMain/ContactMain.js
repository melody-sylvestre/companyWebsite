    ...
    return (
        <main className="contact_main">
                <div className="contact_text_container">
                    ...
                    {formSubmitted ? <FormSubmittedBox/> : <ContactForm setFormSubmitted={setFormSubmitted} formSubmitted={formSubmitted} />}

                </div>
                <img src="images/Img_Contact.png" alt="Company logo" />
